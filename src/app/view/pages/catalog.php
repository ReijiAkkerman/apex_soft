                                ...
                                <article class="product-card" data-type="<?= $product->type ?>">
                                    ...
                                    <div class="product-card__body">
                                        ...
                                        <?php
                                            if(isset($this->login)) {
                                        ?>
                                        <div class="product-card__quantity" <?php
                                            if($product->amount)
                                                echo 'style="display:flex;"';
                                            else 
                                                echo 'style="display:none;"';
                                        ?>>
                                            <div class="quantity__control Reiji_decrement_product" data-quantity="minus">-</div>
                                            <input class="quantity__current Reiji_product_amount Reiji_id-<?= $product->ID ?>" type="text" value="<?= $product->amount ?>" readonly></input>
                                            <div class="quantity__control Reiji_increment_product" data-quantity="plus">+</div>
                                        </div>
                                        <?php } ?>
                                    </div>
                                    <?php 
                                        if(isset($this->login)) {
                                    ?>
                                    <button class="product-card__add btn" <?php
                                        if($product->amount)
                                            echo 'style="display:none;"';
                                        else 
