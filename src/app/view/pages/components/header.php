<header class="header">
            ...
            <nav class="nav header__nav header__nav--top">
                <ul class="nav__list nav__list--top">
                    <li class="nav__item"><a
                            ...
                            class="nav__link icon-adress">Россия, г. Брянск, переулок Осоавиахима, 3А , офис 603</a></li>
                    <li class="nav__item"><a href="tel:+74832320117" class="nav__link icon-phone">+7 (4832) 320-117</a></li>
                    <li class="nav__item"><a href="mailto:info@1capexsoft.ru" class="nav__link icon-mail">info@1capexsoft.ru</a>
                    </li>
                    <li class="nav__item"><a href="#" class="nav__link icon-calendar-alt-fill">Время работы <time
                                datetime="10:00">10:00</time>-<time datetime="17:00">17:00</time></a></li>
                    <li class="nav__item"><a href="#" class="nav__link icon-user">Войти</a></li>
                </ul>
            </nav>
        </div>
    </div>
    <div class="header__fixed">
        <div class="container header__container header__container--fixed">
            <a href="/" class="logo header__logo" aria-label="Логотип Апекс Софт"><img src="assets/img/logo.png"
                ...
                <nav class="nav header__nav header__nav--fixed">
                    <ul class="nav__list nav__list--fixed">
                        ...
                        <li class="nav__item nav__item--fixed">
                            ...
                            <ul class="nav__list-description"></ul>
                        </li>
                        <li class="nav__item nav__item--fixed">
                            <a href="" class="nav__link nav__link--fixed">Каталог</a>
                        </li>
